...
CREATE TABLE "HermesMemory" (
    ...
    CONSTRAINT "HermesMemory_pkey" PRIMARY KEY ("namespace","id")
);
...
-- CreateIndex
CREATE INDEX "HermesMemory_namespace_status_idx" ON "HermesMemory"("namespace", "status");

-- CreateIndex
CREATE UNIQUE INDEX "HermesMemory_namespace_path_key" ON "HermesMemory"("namespace", "path");
